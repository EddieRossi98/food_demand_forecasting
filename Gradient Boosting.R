...
# runtime: 2.5 minutes
m1=gbm(num_orders ~ ., data=X_train, distribution="gaussian", n.trees=100, interaction.depth=10)
...
yhat.boost=predict(m1, newdata = X_val, n.trees=1:100)
err = apply(yhat.boost, 2, function(pred) mean((X_val$num_orders - pred)^2))
err
...
plot(m1$train.error, type="l", ylim = c(0,150000))
